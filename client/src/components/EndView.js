...
export default function EndView(props) {
    ...
    return (
        <div className="app-card end-view">
            <h1 className="app-card__title">{score === "6/6" ? "Perfect score! " : "Your score: "} {score}</h1>
            ...
            <p>
                <button id="shareButton" className="app-card__share-button" onClick={handleClick}>
                    <span>Share</span>&nbsp;
            ...
            <p className="app-card__countdown"><Countdown handleState={handleState}/></p>
            <UserStats/>
        </div>
    )
}